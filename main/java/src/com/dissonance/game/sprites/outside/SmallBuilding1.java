...
public class SmallBuilding1 extends ImagePhysicsSprite {
    public SmallBuilding1() {
        super("sprites/buildings/smallbuilding1.png");
    }

    @Override
    public String hitboxConfigPath() {
        return "sprites/buildings/smallbuilding1.txt";
    }
