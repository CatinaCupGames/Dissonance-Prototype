...
public class SmallBuilding4 extends ImagePhysicsSprite {
    public SmallBuilding4() {
        super("sprites/buildings/smallbuilding4.png");
    }

    @Override
    public String hitboxConfigPath() {
        return "sprites/buildings/smallbuilding4.txt";
    }
