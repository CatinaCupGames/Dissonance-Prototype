...
public class SmallBuilding3 extends ImagePhysicsSprite {
    public SmallBuilding3() {
        super("sprites/buildings/smallbuilding3.png");
    }

    @Override
    public String hitboxConfigPath() {
        return "sprites/buildings/smallbuilding3.txt";
    }
    @Override
    public void render() {
        update();
